...
wget -O "/userdata/system/switch/CONFIG.txt" "https://raw.githubusercontent.com/geekreative/batocera_switch_installer/main/emulators/system/switch/extra/batocera-switch-config.txt"
# -------------------------------------------------------------------- 
...
mkdir -p /tmp 
wget -O "/tmp/batocera-switch-updater.sh" "https://raw.githubusercontent.com/geekreative/batocera_switch_installer/main/emulators/system/switch/extra/batocera-switch-updater.sh" 
