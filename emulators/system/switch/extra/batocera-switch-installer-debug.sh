...
wget -O "/userdata/system/switch/CONFIG.txt" "https://raw.githubusercontent.com/geekreative/batocera-switch/project/system/switch/extra/batocera-switch-config.txt"
# -------------------------------------------------------------------- 
...
mkdir -p /tmp 
wget -O "/tmp/batocera-switch-updater.sh" "https://raw.githubusercontent.com/geekreative/batocera-switch/project/system/switch/extra/batocera-switch-updater.sh" 
