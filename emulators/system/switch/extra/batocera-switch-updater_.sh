...
#link_ryujinx=https://github.com/geekreative/batocera.pro/raw/project/switch/extra/ryujinx-1.1.382-linux_x64.tar.gz
#link_ryujinxavalonia=https://github.com/geekreative/batocera.pro/raw/project/switch/extra/test-ava-ryujinx-1.1.382-linux_x64.tar.gz
...
if [ "$N" = "1" ]; then C=""; else C="$E/$N"; fi
   function generate_launcher() {
         f=/userdata/system/switch/yuzu.AppImage_
         rm "$f" 2>/dev/null
         echo '#!/bin/bash' >> "$f"
...
cd $temp/$emu
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$extra/$emu/xdg-mime" "https://github.com/geekreative/batocera.pro/raw/project/switch/extra/xdg-mime"
###curl -sSf "https://github.com/geekreative/batocera.pro/raw/project/switch/extra/xdg-mime" -o "$extra/$emu/xdg-mime"
...
# -------------------------------------------------------------------
# RYUJINXLDN:
#link_ryujinxldn=https://github.com/geekreative/batocera.pro/raw/project/switch/extra/ava-ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
#link_ryujinxldn=https://github.com/geekreative/batocera.pro/raw/project/switch/extra/ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
link_ryujinxldn=https://github.com/geekreative/batocera.pro/raw/project/switch/extra/ryujinx-1.1.0-ldn3.1.3-linux_x64.tar.gz
## -------------------------------------------------------------------
# RYUJINXAVALONIA:
link_ryujinxavalonia=https://github.com/Ryujinx/release-channel-master/releases/download/$release_ryujinx/test-ava-ryujinx-$release_ryujinx-linux_x64.tar.gz
#
